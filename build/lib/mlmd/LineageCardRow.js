...
var LineageCardRow = /** @class */ (function (_super) {
    ...
    LineageCardRow.prototype.render = function () {
        ...
        var linkDestination = this.getResourceDetailsLink() || '';
        var linkName = Utils_1.getResourceName(this.props.resource);
        return (React.createElement("div", { className: "cardRow " + (isLastRow ? 'lastRow' : '') },
            this.checkRadio(),
            React.createElement("footer", null,
                React.createElement(react_router_dom_1.Link, { className: 'rowTitle', to: linkDestination }, linkName),
    ...
    LineageCardRow.prototype.getResourceDetailsLink = function () {
        if (!this.props.buildArtifactDetailsRoute || !(this.props.cardType === 'artifact'))
            return;
        var artifact = this.props.resource;
