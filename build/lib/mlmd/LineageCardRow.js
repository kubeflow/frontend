...
var LineageCardRow = /** @class */ (function (_super) {
    ...
    LineageCardRow.prototype.render = function () {
        var _a = this.props, isLastRow = _a.isLastRow, type = _a.type;
        var canTarget = type === 'artifact';
        var cardRowClasses = typestyle_1.classes('cardRow', isLastRow && 'lastRow', canTarget && 'clickTarget');
        return (React.createElement("div", { className: cardRowClasses, onClick: this.handleClick },
            this.checkRadio(),
    ...
    LineageCardRow.prototype.handleClick = function (e) {
