...
var LineageActionBar = /** @class */ (function (_super) {
    ...
    LineageActionBar.prototype.render = function () {
        ...
        var breadcrumbs = [
            ...
            React.createElement("aside", { key: 'workspace-sep', className: actionBarCss.workspaceSep }),
        ];
        this.state.history.forEach(function (artifact, index) {
            ...
            breadcrumbs.push(React.createElement("button", { key: "breadcrumb-" + index, className: typestyle_1.classes(isActive ? actionBarCss.breadcrumbActive : actionBarCss.breadcrumbInactive), disabled: isActive, onClick: onBreadcrumbClicked }, Utils_1.getArtifactName(artifact)));
            if (!isActive) {
