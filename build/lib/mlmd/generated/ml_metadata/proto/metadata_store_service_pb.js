...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.ml_metadata.PutArtifactTypeRequest.toObject = function (includeInstance, msg) {
        var f, obj = {
            ...
            allFieldsMatch: jspb.Message.getFieldWithDefault(msg, 4, true)
        };
        if (includeInstance) {
            obj.$jspbMessageInstance = msg;
        }
...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.ml_metadata.PutExecutionResponse.toObject = function (includeInstance, msg) {
        var f, obj = {
            ...
            contextIdsList: jspb.Message.getRepeatedField(msg, 3)
        };
        if (includeInstance) {
            obj.$jspbMessageInstance = msg;
        }
...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.ml_metadata.PutTypesRequest.toObject = function (includeInstance, msg) {
        var f, obj = {
            ...
            canAddFields: jspb.Message.getField(msg, 4),
            canDeleteFields: jspb.Message.getField(msg, 5),
            allFieldsMatch: jspb.Message.getFieldWithDefault(msg, 6, true)
        };
        if (includeInstance) {
            obj.$jspbMessageInstance = msg;
        }
...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.ml_metadata.PutTypesResponse.toObject = function (includeInstance, msg) {
        var f, obj = {
            ...
            contextTypeIdsList: jspb.Message.getRepeatedField(msg, 3)
        };
        if (includeInstance) {
            obj.$jspbMessageInstance = msg;
        }
...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.ml_metadata.GetContextByTypeAndNameRequest.toObject = function (includeInstance, msg) {
        var f, obj = {
            typeName: jspb.Message.getField(msg, 1),
            contextName: jspb.Message.getField(msg, 2)
        };
        if (includeInstance) {
            obj.$jspbMessageInstance = msg;
        }
